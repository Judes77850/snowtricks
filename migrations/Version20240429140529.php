 ...
 */
final class Version20240429140529 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE media (id INT AUTO_INCREMENT NOT NULL, trick_id_id INT DEFAULT NULL, user_id_id INT DEFAULT NULL, category_id_id INT DEFAULT NULL, path VARCHAR(255) NOT NULL, is_video TINYINT(1) NOT NULL, INDEX IDX_6A2CA10CB46B9EE8 (trick_id_id), INDEX IDX_6A2CA10C9D86650F (user_id_id), UNIQUE INDEX UNIQ_6A2CA10C9777D11E (category_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', password VARCHAR(255) NOT NULL, user_name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE media ADD CONSTRAINT FK_6A2CA10C9D86650F FOREIGN KEY (user_id_id) REFERENCES users (id)');
