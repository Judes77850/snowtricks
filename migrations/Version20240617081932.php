 ...
 */
final class Version20240617081932 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE media (id INT AUTO_INCREMENT NOT NULL, user_id_id INT DEFAULT NULL, category_id_id INT DEFAULT NULL, trick_id INT NOT NULL, path VARCHAR(255) NOT NULL, is_video TINYINT(1) NOT NULL, INDEX IDX_6A2CA10C9D86650F (user_id_id), INDEX IDX_6A2CA10C9777D11E (category_id_id), INDEX IDX_6A2CA10CB281BE2E (trick_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
